...
public class PositionSpecification {
    public static Specification<Position> buildSpecification(Map<String, FilterCriteria> filters) {
        return (root, query, cb) -> {
            ...
            if (filters != null) {
                for (Map.Entry<String, FilterCriteria> entry : filters.entrySet()) {
                    ...
                    if (field.equalsIgnoreCase("permissionId")) {
                        Join<Position, Permission> permJoin = root.join("permissions");
